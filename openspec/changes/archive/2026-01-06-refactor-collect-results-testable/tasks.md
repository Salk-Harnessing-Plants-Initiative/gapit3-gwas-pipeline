...
- [x] Verify script still runs correctly after removing duplicates
...
- [x] Note module structure in relevant docs (optional, not blocking)
- [x] Update SCRIPTS_REFERENCE.md if exists (optional)
